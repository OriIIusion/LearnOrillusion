...
export default class demo {
    ...
    async run() {
        ...
        //快速添加一个地面
        const floor = Object3DUtil.GetSingleCube(40, 1, 40, 0.6, 0.6, 0.6);
        floor.y = -11;
    ...
    async initscene() {
        ...
        const button = gui.addFolder("Add Remove");
        ...
        light.add(this.light, "intensity", 0.1, 2, 0.01);
