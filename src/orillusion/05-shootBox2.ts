...
export default class demo {
    ...
    async run() {
        ...
        const con = cameraObj.addComponent(HoverCameraController);
        ...
        //添加瞄准点
        {
            ...
            const aim1 = Object3DUtil.GetSingleCube(0.5, 2, 0.5, 0.6, 0.3, 0.1);
            this.aim.addChild(aim1);
            const aim2 = Object3DUtil.GetSingleCube(0.5, 2, 0.5, 0.6, 0.3, 0.1);
            aim2.rotationZ = 90;
